...
public class RandomInfo {
    ...
    private final String[] driveOfferedCurrency = {"Euro","Shekel","Dollar","Euro","Pound","Shekel","Pound","Dollar"};
    ...
    public RandomDrive getRandomDrive(double minDistanceMeters, double maxDistanceMeters, Date minStartTime, Date maxStartTime, int minDetourPercent, int maxDetourPercent) {
        ...
        if(routePoints != null) {
            ...
            return new RandomDrive(
                ...
                randomArrayItem(driveOfferedCurrency),
...
//    }
    ...
    public class RandomDrive {
        ...
        private final String name, comment , offeredCurrency;
        ...
        public RandomDrive(String name, String comment, Point startPt, Point endPt, java.sql.Date startTime, Integer detourMinutes, Integer detourKm, Integer detourPercent, int offeredSeatsNo, String offeredCurrency, RoutePoint[] routePoints) {
            this.name = name;
