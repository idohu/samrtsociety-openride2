...
public interface RiderUndertakesRideControllerLocal {
    ...
    int getDecentRatingsTotalByCustomerAndDate(CustomerEntity customer, Date fromDate);

    int getDecentRatingsTotalByCustomer(CustomerEntity customer);
    ...
    int getMediocreRatingsTotalByCustomerAndDate(CustomerEntity customer, Date fromDate);

    int getMediocreRatingsTotalByCustomer(CustomerEntity customer);
