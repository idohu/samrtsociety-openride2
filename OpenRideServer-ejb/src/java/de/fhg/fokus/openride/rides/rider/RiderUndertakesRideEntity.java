...
@NamedQueries({
    ...
    @NamedQuery(name = "RiderUndertakesRideEntity.countDecentRatingsAsRider", query = "SELECT COUNT(r.riderrouteId) FROM RiderUndertakesRideEntity r WHERE r.custId = :custId AND r.receivedrating = 1 AND r.receivedratingDate > :fromDate"),
    ...
    @NamedQuery(name = "RiderUndertakesRideEntity.countMediocreRatingsAsRider", query = "SELECT COUNT(r.riderrouteId) FROM RiderUndertakesRideEntity r WHERE r.custId = :custId AND r.receivedrating = -1 AND r.receivedratingDate > :fromDate"),
    ...
    @NamedQuery(name = "RiderUndertakesRideEntity.countDecentRatingsAsDriver", query = "SELECT COUNT(r.riderrouteId) FROM DriverUndertakesRideEntity d, RiderUndertakesRideEntity r WHERE d.custId = :custId AND r.rideId = d AND r.givenrating = 1 AND r.givenratingDate > :fromDate"),
    ...
    @NamedQuery(name = "RiderUndertakesRideEntity.countMediocreRatingsAsDriver", query = "SELECT COUNT(r.riderrouteId) FROM DriverUndertakesRideEntity d, RiderUndertakesRideEntity r WHERE d.custId = :custId AND r.rideId = d AND r.givenrating = -1 AND r.givenratingDate > :fromDate"),
