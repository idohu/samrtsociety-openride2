...
@NamedQueries({
    ...
    @NamedQuery(name = "DriverUndertakesRideEntity.findByRideOfferedCurrency", query = "SELECT d FROM DriverUndertakesRideEntity d WHERE d.rideOfferedCurrency = :rideOfferedCurrency"),
...
public class DriverUndertakesRideEntity implements Serializable {
    ...
    @Column(name = "ride_offeredCurrency")
    private String rideOfferedCurrency;
    ...
    public DriverUndertakesRideEntity(Date rideStarttime,
            ...
            int rideOfferedseatsNo, String rideOfferedCurrency, Integer rideAcceptableDetourInMin,
        ...
        this.rideOfferedCurrency = rideOfferedCurrency;
    ...
    public String getRideOfferedCurrency() {
        return rideOfferedCurrency;
    }

    public void setRideOfferedCurrency(String rideOfferedCurrency) {
        this.rideOfferedCurrency = rideOfferedCurrency;
    }
