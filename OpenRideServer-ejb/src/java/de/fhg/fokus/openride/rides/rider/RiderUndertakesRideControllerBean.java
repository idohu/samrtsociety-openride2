...
//        List<AccountHistoryEntity> a = (List<AccountHistoryEntity>)em.createNamedQuery("AccountHistoryEntity.findByCustId").setParameter("custId", customer.getCustId()).getResultList();
    ...
    public int getDecentRatingsTotalByCustomerAndDate(CustomerEntity customer, Date fromDate) {
        int decentRatings = 0;
        try {
            if (fromDate == null) {
                // By default, calculate date - 12 months back
            ...
            decentRatings = Integer.parseInt(em.createNamedQuery("RiderUndertakesRideEntity.countDecentRatingsAsRider").setParameter("custId", customer).setParameter("fromDate", fromDate).getSingleResult().toString());
            decentRatings += Integer.parseInt(em.createNamedQuery("RiderUndertakesRideEntity.countDecentRatingsAsDriver").setParameter("custId", customer).setParameter("fromDate", fromDate).getSingleResult().toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return decentRatings;
    }

    public int getDecentRatingsTotalByCustomer(CustomerEntity customer) {
        return getDecentRatingsTotalByCustomerAndDate(customer, null);
    }
    ...
    public int getMediocreRatingsTotalByCustomerAndDate(CustomerEntity customer, Date fromDate) {
        int medRatings = 0;
        try {
            if (fromDate == null) {
                // By default, calculate date - 12 months back
            ...
            medRatings = Integer.parseInt(em.createNamedQuery("RiderUndertakesRideEntity.countMediocreRatingsAsRider").setParameter("custId", customer).setParameter("fromDate", fromDate).getSingleResult().toString());
            medRatings += Integer.parseInt(em.createNamedQuery("RiderUndertakesRideEntity.countMediocreRatingsAsDriver").setParameter("custId", customer).setParameter("fromDate", fromDate).getSingleResult().toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return medRatings;
    ...
    public int getMediocreRatingsTotalByCustomer(CustomerEntity customer) {
        return getNeutralRatingsTotalByCustomerAndDate(customer, null);
    }
