...
public class Profile {
    ...
    public void initialize() {
        ...
        String imgFullPath = "C:\\Users\\Omri\\Documents\\NetBeansProjects\\OpenRideServer\\OpenRideWeb\\web\\img\\profile/";
        File image = new File(imgFullPath + managedUserBean.getUsername() + "_" + managedUserBean.getId() + ".jpg");
            if (image.exists())
        pictureBasename = "img/profile/"+ managedUserBean.getUsername() + "_" + managedUserBean.getId();
            else
        pictureBasename = "img/profile/default";
        //pictureBasename = "/img/profile/default";
        ...
        logger.log(Level.INFO, "prefIsSmoker: {0}", managedUserBean.isDriverPrefIsSmoker());
    ...
    public void editPicture() {
        ...
        String profilePicturesPath1 = "C:\\Users\\Omri\\Documents\\NetBeansProjects\\OpenRideServer\\OpenRideWeb\\web\\img\\profile/";
        String profilePicturesPath2 = "C:\\Users\\maxam\\Desktop\\pics/";
        //String profilePicturesPath = "C:\\Users\\Omri\\Desktop\\glassfish-3.0.1\\glassfish\\domains\\domain1\\pictures/";//"./pictures/";
        ...
        try {
            ...
            File outputPicture1 = new File(profilePicturesPath1, uploadedFileName + ".jpg");
            File outputPicture2 = new File(profilePicturesPath2, uploadedFileName + ".jpg");
            if (!ImageIO.write(bim, "jpg", outputPicture1) || !ImageIO.write(bim, "jpg", outputPicture2)) {
            try
            {
            PrintWriter writer = new PrintWriter("next-one-file.txt", "UTF-8");
            writer.println("inside imageio");
            writer.close();
            }
            catch(Exception e){}
                setRenderPictureErrorMessage(true);
            ...
            outputPicture1 = new File(profilePicturesPath1, uploadedFileName + "_thumb.jpg");
            outputPicture2 = new File(profilePicturesPath2, uploadedFileName + "_thumb.jpg");
            if (/*!ImageIO.write(bim, "jpg", outputPicture1) ||*/ !ImageIO.write(bim, "jpg", outputPicture2)) {
    ...
    public void validateYear(FacesContext context, UIComponent toValidate,
        ...
        if (yearValue == null || yearValue < 1900 || yearValue > cal.get(Calendar.YEAR)) {
            FacesMessage message = new FacesMessage("Please enter year in Format \"YYYY\" only.");
            throw new ValidatorException(message);
        }
