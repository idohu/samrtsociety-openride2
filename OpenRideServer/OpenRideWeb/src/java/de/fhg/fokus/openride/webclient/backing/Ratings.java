...
public class Ratings {
    ...
    private int ratingsLatestDecent;
    private int ratingsLatestNeutral;
    private int ratingsLatestMediocre;
    ...
    private void setLatestRatings() {
        ...
        ratingsLatestDecent = riderundertakesrideControllerBean.getDecentRatingsTotalByCustomer(customer);
        ratingsLatestNeutral = riderundertakesrideControllerBean.getNeutralRatingsTotalByCustomer(customer);
        ratingsLatestMediocre = riderundertakesrideControllerBean.getMediocreRatingsTotalByCustomer(customer);
    ...
    public int getRatingsLatestMediocre() {
        return ratingsLatestMediocre;
    }

    public void setRatingsLatestMediocre(int ratingsLatestMediocre) {
    ...
    public int getRatingsLatestDecent() {
        return ratingsLatestDecent;
    }

    public void setRatingsLatestDecent(int ratingsLatestDecent) {
