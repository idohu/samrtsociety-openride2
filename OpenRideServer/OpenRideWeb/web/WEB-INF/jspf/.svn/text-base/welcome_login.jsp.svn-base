...
<%@taglib prefix="h" uri="http://java.sun.com/jsf/html"%>
    ...
    <fieldset style="min-height: 150px;">
        <legend>Sie kennen sich schon aus?</legend>

        <p>Loggen Sie sich ein, um Ihr persönliches Profil aufzurufen.</p>
        ...
        <p>Passwort vergessen? <br />Wenden Sie sich an <a href="mailto:openride-support@lists.sourceforge.net">openride-support@lists.sourceforge.net</a>.</p>
