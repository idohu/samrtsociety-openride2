    ...
    <fieldset style="min-height: 150px;">
        ...
        <form id="loginForm" action="j_security_check" method="post">
            <table border="0" width="100%">
                <tbody>
                    <tr>
                        <td class="column33"><label for="j_username" class="requiredField">User name:</label> <span class="requiredField">(*)</span></td>
                    ...
                    <tr>
                        ...
                        <td class="column66"><input type="submit" name="submit" value="Login" onclick=""/></td>
                    </tr>
                </tbody>
            </table>
        </form>
