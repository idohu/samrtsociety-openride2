...
<div style="float: left; width: 131px;">
    <t:subform id="profileInfoForm">
        ...
        <p><h:outputText value="#{Ratings_Backing.ratingsRatioPercent}" />% positive review<br />(last 12 Months)</p>
    </t:subform>
    <p style="background-color: #fff; padding-top: 1em; border-top: 1px solid #ddd; width: 125px; text-align: center;">Use Openride without suitable smartphone with
